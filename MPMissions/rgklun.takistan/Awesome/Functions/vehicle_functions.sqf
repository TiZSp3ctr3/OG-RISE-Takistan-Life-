...
vehicle_set_modifications = {
	...
	switch (_item) do {
		...
		case "SUV_UN_EP1_retex": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\suvpolice.paa"]';
			_vehicle setvariable ["tuning", 2, true];
			processInitCommands;
		};				
		
		case "Volha_1_TK_CIV_EP1_cop": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\vohla_cop.paa"]';
			_vehicle setvariable ["tuning", 1, true];
			processInitCommands;
		};		
		
		case "SUV_TK_CIV_EP1": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\civsuv.paa"]';
			processInitCommands;
		};
		case "SUV_TK_vice_EP1_civ": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\civsuv.paa"]';
			processInitCommands;
		};
		case "hilux1_civil_1_open_police_retex": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\policetruck.paa"]';
			_vehicle setvariable ["tuning", 2, true];
			processInitCommands;
		};
		case "hilux1_civil_1_open_camo": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\camo_truck.paa"]';
			processInitCommands;
		};
		case "hilux1_civil_1_open_camo_don": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\camo_truck.paa"]';
			processInitCommands;
		};
		case "SUV_TK_EP1_b_vip": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\vipsuvblack.paa"]';
			_vehicle setVariable ["tuning",3,true];
			processInitCommands;
		};		
		case "SUV_TK_EP1_w_vip": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\vipsuv.paa"]';
			_vehicle setVariable ["tuning",3,true];
			processInitCommands;
		};
		case "SUV_TK_EP1_esu": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\esusuv.jpg"]';
			processInitCommands;
		};

		case "SUV_TK_EP1_retex_special": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\suvpolice.paa"]';
			_vehicle setvariable ["tuning", 5, true];
			processInitCommands;
		};
		case "LandRover_TK_CIV_EP1_cop": {
			_vehicle setvariable ["tuning", 5, true];
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\cop_landrover.paa"]';
			processInitCommands;
		};
		...
		case "SUV_UN_EP1_un": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\suvun.paa"]';
			processInitCommands;
		};

		case "SUV_TK_EP1_don": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\suvdonator.paa"]';
			processInitCommands;
		};		
		case "SUV_TK_EP1_ani": {
			_vehicle setVehicleInit ' this setObjectTexture [0,"resources\images\newsuv.jpg"]';
			processInitCommands;
		};
		...
		case "C130J_US_EP1_cop": {
			[_vehicle] execvm "Scripts\ac130.sqf";
			processInitCommands;
			};
		case "C130J_US_EP1_op4": {
			[_vehicle] execvm "Scripts\ac130.sqf";
			processInitCommands;
			};
		...
		case "AW159_Lynx_BAF_hydra": {
			_vehicle addmagazine "60Rnd_CMFlareMagazine";
			_vehicle removeWeapon "CRV7_PG";
			_vehicle removeWeapon "M621";
		};
		case "Ka60_GL_PMC": {
			_vehicle removeweapon "57mmLauncher";
			_vehicle addweapon "CMFlareLauncher";
		...
		case "AH6J_EP1_don_cop": {
			_vehicle addweapon "CMFlareLauncher";
			_vehicle addMagazine "210Rnd_25mm_M242_APDS";
			_vehicle addMagazine "210Rnd_25mm_M242_APDS";

			_vehicle addMagazine "210Rnd_25mm_M242_APDS";
			_vehicle addweapon "M242";
			_vehicle removeweapon "FFARLauncher_14";
			_vehicle addmagazine "60Rnd_CMFlareMagazine";
		};
		case "An2_TK_Cop": {
		...
		case "MQ9PredatorB_armed": {
			_vehicle removeweapon "HellfireLauncher";
			_vehicle addweapon "BombLauncherF35";
			_vehicle addmagazine "2Rnd_GBU12";
		};
		...
		case "F35B_don": {
			...
			_vehicle addmagazine "2Rnd_Sidewinder_F35";
			_vehicle addmagazine "14Rnd_FFAR";
			_vehicle addmagazine "220Rnd_25mm_GAU2";
			_vehicle addmagazine "220Rnd_25mm_GAU2";
			_vehicle addweapon "FFARLauncher_14";
		...
		case "F35B": {
			...
			_vehicle addmagazine "2Rnd_Sidewinder_F35F35";
			_vehicle addmagazine "2Rnd_Sidewinder_F35";
			_vehicle addmagazine "14Rnd_FFAR";
			_vehicle addmagazine "220Rnd_25mm_GAU2";
			_vehicle addmagazine "220Rnd_25mm_GAU2";
		...
		case "Mi171Sh_rockets_CZ_EP1_don": {
			_vehicle removeMagazineTurret ["192Rnd_57mm",[-1]];
		};		
		case "Mi171Sh_rockets_CZ_EP1_srt": {
			_vehicle removeMagazineTurret ["192Rnd_57mm",[-1]];
		};
		...
		case "An2_TK_EP1": {
			...
			_vehicle addmagazine "500Rnd_TwinVickers";
			_vehicle addmagazine "500Rnd_TwinVickers";
			_vehicle setvariable ["GrenadeLeft", true, true];
		};
		case "L39":{
			_vehicle removeweapon "GSh23L_L39";
			_vehicle removeweapon "57mmLauncher";
		...
		case "Lada2_TK_CIV_EP1_bomb": {
			_vehicle setvariable ["tuning", 1, true];
			bomb = _vehicle addaction ["Push Red Button","Scripts\bomb_car.sqf"];

		};
		case "HMMWV_DES_EP1_srt": {
			_vehicle setvariable ["tuning", 3, true];
			_vehicle setVehicleInit ' this setObjectTexture [0, "#(argb,8,8,3)color(0.2,0.2,0.2,0.5,ca)"]';
		};
		...
		case "Ka60_GL_PMC_srt":
		{
			_vehicle addmagazineturret ["6Rnd_Smoke_M203", [0]];
			_vehicle addmagazineturret ["6Rnd_Smoke_M203", [1]];
		};
		case "M1133_MEV_EP1_srt":
		{
			_vehicle addWeapon "TruckHorn2";
		};	

		case "UH60M_MEV_EP1_esu":
		{
			_vehicle setVehicleInit ' this setObjectTexture [0, "#(argb,8,8,3)color(1,1,0,1,ca)"]';
			_vehicle setVehicleInit ' this setObjectTexture [1, "#(argb,8,8,3)color(1,0.2,0.2,0.5,ca)"]';
			processInitCommands;
			
		};

		case "UH1H_TK_GUE_EP1_srt":
		{
			for "_x" from 1 to 2 do
			{
				_vehicle addmagazineturret ["100Rnd_762x51_M240", [0]];
		...
		case "stunhmmv":
		{
			_vehicle removeWeapon "M240BC_veh";
			_vehicle addMagazine "8Rnd_B_Beneli_74Slug";
			_vehicle addMagazine "8Rnd_B_Beneli_74Slug";
			
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addMagazine "8Rnd_B_Beneli_Pellets";
			_vehicle addWeapon "M1014";
		};	
		
		case "KamazOpen_IglaTruck":
		{
			Truck = _vehicle;
			[] spawn {
				vehicle_IglaPod = "Igla_AA_pod_East" createVehicle (getPos insdcarspawn);
				vehicle_IglaPod attachTo [Truck, [0.3, -1, 1]];
				waitUntil { (isNull Truck) or (getDammage Truck == 1) };
				deleteVehicle vehicle_IglaPod;
			};

		};	

		case "HMMWV_M1035_DES_EP1_srt":
		{
			_vehicle setVehicleInit ' this setObjectTexture [0, "#(argb,8,8,3)color(0.2,0.2,0.2,0.5,ca)"]';
			_vehicle setVehicleInit ' this setObjectTexture [1, "#(argb,8,8,3)color(0.2,0.2,0.2,0.5,ca)"]';
			_vehicle setVehicleInit ' this setObjectTexture [2, "#(argb,8,8,3)color(0.2,0.2,0.2,0.5,ca)"]';
			_vehicle setVehicleInit ' this setObjectTexture [3, "#(argb,8,8,3)color(0.2,0.2,0.2,0.5,ca)"]';
			processInitCommands;
		};
		case "Ikarus_TK_CIV_EP1_double":
		{
			_vehicle setVehicleInit ' this setObjectTexture [0, "#(rgb,8,8,3)color(1,0,0,1,ca)"]';
			
			_top = "Ikarus_TK_CIV_EP1" createVehicle (getpos _vehicle);
			_top attachto [_vehicle,[0,0,2.5]];
			_top setVehicleInit ' this setObjectTexture [0, "#(rgb,8,8,3)color(1,0,0,1,ca)"]';
			_top setVariable ["car_save",true,true];
			_top setVariable ["isPlayerVehicle",true,true];
			_top lock true;
...
vehicle_create = {
	...
	_vehicle addEventHandler ["fired", {_this call A_fnc_veh_EH_hFired}];
...
vehicle_create_shop_extended = {
	...
	[_vehicle, name player] call vehicle_set_owner;
...
vehicle_set_owner = {
	...
	_vehicle setVariable ["vehicle_owner",_name,true];
};

vehicle_get_owner = {
	private ["_vehicle","_var"];
	_vehicle = _this;
	_var = _vehicle getVariable ["vehicle_owner",nil];
	_var
};
...
vehicle_unflip = {
	_vcl = (nearestobjects [[player] call FNC_getpos, ["LandVehicle"], 10] select 0);
...
vehicle_lockpick = {
	...
	if ((player distance (getMarkerPos "pmc_base")) <= 30) exitwith {
		player groupChat "You cannot lockpick vehicles in PMC base";
	};
