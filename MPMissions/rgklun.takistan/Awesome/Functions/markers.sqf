...
marker_side_loop_draw = {
	...
	if ([_player_variable,"restrained"] call player_get_bool or [_player_variable,"ziptied"] call player_get_bool) exitWith {
		_local_marker setMarkerAlphaLocal 0;
	};
	...
	private["_location"];
	_location = [_player_variable] call FNC_getpos;
