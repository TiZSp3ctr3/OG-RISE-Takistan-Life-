...
RadioTrigger_5 setTriggerStatements ["this", "[RadioTextMsg_5, RadioTextArt_5] call SayDirectSpeach;", ""];
5 setRadioMsg "Say Text 5";
...
RadioTrigger_6 setTriggerStatements ["this", "[""Einstellungen""] call A_SCRIPT_SETTINGS;", ""];
6 setRadioMsg "Settings";
