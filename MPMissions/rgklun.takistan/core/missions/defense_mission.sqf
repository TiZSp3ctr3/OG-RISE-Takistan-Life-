...
*/
	...
	_mission = defense_array select floor random count defense_array;;
	...
	player groupChat format ["You have been assigned to defend %1 from insurgents. Hold that area for 10 minutes for a reward of $200,000",_name];
