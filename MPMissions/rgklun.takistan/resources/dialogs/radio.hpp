...
class CLAY_CarRadio_RadioDlg
{
	...
	class CLAY_RADIO_ButtonVolUp: CLAY_RscRadioButton
	{
		idc = 603;
		text = "+";
		action = "['volUp'] spawn CLAY_RadioSettings";
		x = 0.125;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonVolDown: CLAY_RscRadioButton
	{
		idc = 604;
		text = "-";
		action = "['volDown'] spawn CLAY_RadioSettings";
		x = 0.125;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayPause: CLAY_RscRadioButton
	{
		idc = 626;
		text = ">";
		action = "['play'] spawn CLAY_RadioControls";
		x = 0.125;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPre: CLAY_RscRadioButton
	{
		idc = 615;
		text = "<<";
		action = "['pre'] spawn CLAY_RadioControls";
		x = 0.77;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonNext: CLAY_RscRadioButton
	{
		idc = 616;
		text = ">>";
		action = "['next', 1] spawn CLAY_RadioControls";
		x = 0.83;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceUp: CLAY_RscRadioButton
	{
		idc = 617;
		text = "/\";
		action = "['sourceUp'] spawn CLAY_RadioSettings";
		x = 0.8;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceDown: CLAY_RscRadioButton
	{
		idc = 618;
		text = "\/";
		action = "['sourceDown'] spawn CLAY_RadioSettings";
		x = 0.8;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayList: CLAY_RscRadioButton
	{
		idc = 620;
		text = "Playlist";
		action = "[] spawn CLAY_RadioPlaylistFnc";
		x = 0.21;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRepeatSelect: CLAY_RscRadioButton
	{
		idc = 621;
		text = "Repeat";
		action = "['playRepeat'] spawn CLAY_RadioSettings";
		x = 0.3;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRandomSelect: CLAY_RscRadioButton
	{
		idc = 622;
		text = "Random";
		action = "['playRandom'] spawn CLAY_RadioSettings";
		x = 0.39;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonKeyColorSelect: CLAY_RscRadioButton
	{
		idc = 623;
		text = "Key Col";
		action = "['kCol'] spawn CLAY_RadioSettings";
		x = 0.48;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonDisplayColorSelect: CLAY_RscRadioButton
	{
		idc = 624;
		text = "Dspl Col";
		action = "['dCol'] spawn CLAY_RadioSettings";
		x = 0.57;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonBackgroundColorSelect: CLAY_RscRadioButton
	{
		idc = 625;
		text = "Design";
		action = "['Color'] spawn CLAY_RadioSettings";
		x = 0.66;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
class CLAY_CarRadio_PlaylistDlg
{
	...
	class CLAY_RADIO_ListPlaylistTracks: CLAY_RscRadioListbox
	{
		...
		w = 0.3;
		h = 0.65;
		onLBDrop = "nul = _this spawn CLAY_RadioLBDrop";
	};
	...
	class CLAY_RADIO_ButtonAddSingle: CLAY_RscRadioButton
	{
		idc = 634;
		text = "<";
		action = "['addSingle'] spawn CLAY_RadioEditor'";
		x = 0.48;
		y = 0.4;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonAddAll: CLAY_RscRadioButton
	{
		idc = 635;
		text = "<<";
		action = "['addAll'] spawn CLAY_RadioEditor'";
		x = 0.48;
		y = 0.51;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveSingle: CLAY_RscRadioButton
	{
		idc = 636;
		text = ">";
		action = "['removeSingle'] spawn CLAY_RadioEditor'";
		x = 0.48;
		y = 0.45;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveAll: CLAY_RscRadioButton
	{
		idc = 637;
		text = ">>";
		action = "['removeAll'] spawn CLAY_RadioEditor'";
		x = 0.48;
		y = 0.56;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonOK: CLAY_RscRadioButton
	{
		idc = 638;
		text = "OK";
		action = "['create'] spawn CLAY_RadioEditor'";
		x = 0.45;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonCancel: CLAY_RscRadioButton
	{
		idc = 639;
		text = "Cancel";
		action = "[] spawn {closeDialog 0; uiSleep 0.1; [] spawn CLAY_RadioOpen};";
		x = 0.575;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRestore: CLAY_RscRadioButton
	{
		idc = 640;
		text = "Restore";
		action = "['restore'] spawn CLAY_RadioEditor'";
		x = 0.325;
		y = 0.825;
		w = 0.1;
		h = 0.05;
